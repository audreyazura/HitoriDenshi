...
public class SimulationTracker
{
     ...
     * @throws IOException 
     */
    private void writeFile(ListType p_listType, BufferedWriter p_writer, PhysicsVariables.UnitsPrefix p_prefix) throws IOException
    {
        ...
        {
            p_writer.newLine();
            toBeWritten = (new BigDecimal(i)).multiply(CalculationConditions.DT).divide(PhysicsVariables.UnitsPrefix.NANO.getMultiplier())+"\t"+trajectoryToWrite.get(i).divide(multiplier, MathContext.DECIMAL32)+"\t"+velocitiesToWrite.get(i).round(MathContext.DECIMAL32);
     ...
     * @throws IOException 
     */
    synchronized public void saveToFile(String p_outputFolder, BigDecimal p_initialPosition, PhysicsVariables.UnitsPrefix p_prefix) throws FileSystemException, IOException
    {
