...
class SCAPSFunction extends ContinuousFunction
{
    ...
    {
       return new SCAPSFunction(p_inputFile, p_unitMultiplier, PhysicsVariables.UnitsPrefix.UNITY.getMultiplier().divide(PhysicsVariables.UnitsPrefix.CENTI.getMultiplier(), MathContext.DECIMAL128), "eb", "\t", 23, new int[] {1,12});
    }
